...
<body class="sidebar-dark">
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar navbar-light col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="{{URL::to('/admin_dashboard')}}"><img src="" alt="Enrolment"></a>
      </div>
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <div class="user-info">
            ...
            <div class="details">
              <p class="user-name">Hosainul Arefin Shetu</p>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="sidebar_layouts">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/english')}}">Eglish</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/law')}}">LAW</a>
                  </li>
                  <li class="nav-item">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="advancedSubmenu">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/add-teacher')}}">Add Teacher</a>
                  </li>
                </ul>
              </div>
            </li>
  ...
  <script>
    $(document).on("click", "delete", function(e){
      ...
      bootbox.confirm("Are you sure want do Delete!", function(confirmed){
        if (confirmed) {
